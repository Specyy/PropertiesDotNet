...
namespace PropertiesDotNet.Test
{
...
#endif
    {
        ...
        /// </summary>
        public uint XOffset { get => Column - 1; }

        /// <summary>
        /// Returns the line number, starting at 0.
        /// </summary>
        public uint YOffset { get => Line - 1; }
        ...
        {
            ulong absOffset = AbsoluteOffset;
        ...
        {
            return AbsoluteOffset == other.AbsoluteOffset ? 0 : (AbsoluteOffset < other.AbsoluteOffset ? -1 : 1);
        }
        ...
        public bool Equals(StreamMark? other)
        {
            return !(other is null) && AbsoluteOffset == other.Value.AbsoluteOffset;
        }
        ...
        {
            return $"Line: {Line}, Column: {Column}, Absolute Offset: {AbsoluteOffset}";
        }
        /// <summary>
        ...
        {
            return (int)(AbsoluteOffset & 0xFFFFFFFF);
        }
    }
}
