...
namespace PropertiesDotNet.Core
{
    ...
    public delegate void TokenRead(IPropertiesReader reader, in PropertiesToken token);
    ...
    public interface IPropertiesReader
    {
        ...
        /// <summary>
        /// Returns the current token as an immutable reference.
        /// </summary>
        /// <exception cref="PropertiesException">If an error was encountered whilst trying to
        /// peek the document, and exceptions are configured to be thrown.</exception>
        ref readonly PropertiesToken Token { get; }
